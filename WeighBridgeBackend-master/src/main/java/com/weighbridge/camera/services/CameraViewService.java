...
public interface CameraViewService {
        ...
        String uploadImagesUserId(Integer ticketNo, MultipartFile frontImg1, MultipartFile backImg2, MultipartFile topImg3,
                MultipartFile bottomImg4, MultipartFile leftImg5, MultipartFile rightImg6,
        ...
        Map<String, byte[]> downloadImagesFromServerPath(Integer ticketNo, String role, String companyId, String siteId,String truckStatus);
}
